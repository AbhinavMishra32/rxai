...
import { AlignHorizontalDistributeEnd, Bold, CloudUpload, Code, Code2, Dot, Italic, List, Quote, Redo, Strikethrough as Strike, Strikethrough, Undo } from 'lucide-react';
        ...
        <div className="relative flex flex-col gap-2 ml-[36px] w-full h-screen" >
            < div className="rounded-xl mt-4" >
                <div className='flex flex-wrap items-center justify-center gap-1 p-3'>
                    ...
                    <button onClick={() => editor.chain().focus().setHorizontalRule().run()} className="px-2 py-2 rounded bg-neutral-800">
                    ...
                    <button className='flex items-center justify-center ml-10 rounded-full bg-neutral-800 hover:bg-neutral-700 h-10 w-10' onClick={saveNote}>
